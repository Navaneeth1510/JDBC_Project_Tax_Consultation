			...
			do {
				...
				switch(choice) {
					...
					case 3: System.out.println("Enter the id of the employee");
							...
							break;
					case 4: System.out.println("Enter the employee id to update the name of the employee:");
							int I=sc.nextInt();
							System.out.println("Enter the new name of the employee to update:");
							String N=sc.next();
							dao.updateID(I, N);
							break;
					case 5: System.out.println("Enter the employee name to delete");
